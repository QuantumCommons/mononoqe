# Contribute to `mononoqe`

`mononoqe` is Apache 2.0 licensed and accepts contributions via GitHub.
...
- The version of `mononoqe` you are using
- Python version
...
- Does this align with the goals of `mononoqe`?
...
- Open a pull request against `mononoqe` master branch that follows [PR guidelines](#pull-request-guidelines)

The maintainers of `mononoqe` use a "Let's Get This Merged" (LGTM) message in the pull request to note that the commits are ready to merge.
